<div>
    <x-slot name="header">
        <div class="flex justify-between items-center" x-data>
            ...
            <x-button type="button" x-on:click="$dispatch('open-create-note-modal')">
                {{ __('Create Note') }}
            </x-button>
        </div>
    </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($notes as $note)
                    <div wire:key="note-{{ $note->id }}"
                        class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 flex flex-col hover:shadow-md transition-shadow duration-200">
                        ...
                        <div
                            ...
                            <div class="space-x-3 flex items-center">
                                ...
                                <button type="button"
                                    x-on:click="$dispatch('open-delete-note-modal', { note: {{ $note->id }} })"
